...
create-sandbox          # setup wizard
create-sandbox ssh      # shell inside the VM
```
...
Running `create-sandbox` with no arguments starts the setup wizard:
...
Generated by `create-sandbox init` (or the wizard). You can also write it by hand:
